...
namespace SystemTheLastBugSpa.Data.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    {
            //        Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            //        NoAssetDischarge = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            //        IntitutionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            //        Activo = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
            //        Decription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            //        ReasonsForDischarge = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedForm = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshToken_AspNetRoles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
