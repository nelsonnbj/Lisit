...
{
    public class StorerFilesServices : IStorerFilesServices
    {
        private readonly string _configuration;

        public StorerFilesServices(IConfiguration configuration)
        {
        ...
        public async Task BorrarArchivo(string ruta, string contenedor)
        {
            ...
            var cliente = new BlobContainerClient(_configuration, contenedor);
        ...
        public async Task<string> GuardarArchivo(byte[] contenido, string extension, string contenedor, string contentType)
        {
            ...
            var blod = cliente.GetBlobClient(archivoNombre);

            var blobUploadOptions = new BlobUploadOptions();
            var blobHttpHeader = new BlobHttpHeaders();
            blobHttpHeader.ContentType = contentType;
            blobUploadOptions.HttpHeaders = blobHttpHeader;
            await blod.UploadAsync(new BinaryData(contenido), blobUploadOptions);
